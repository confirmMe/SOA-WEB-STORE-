...
public class ItemServiceImpl implements ItemService {
	...
	public TaotaoResult ItemDelete(List<Long> params) {
		...
		com.taotao.pojo.TbItemDescExample.Criteria criteriaDesc=exampleDesc.createCriteria();
		com.taotao.pojo.TbItemParamItemExample.Criteria criteriaParam=exampleParam.createCriteria();
		...
		criteriaDesc.andItemIdEqualTo(id);
		descMapper.deleteByExample(exampleDesc);
		
		
		criteriaParam.andItemIdEqualTo(id);
		itemParamItemMapper.deleteByExample(exampleParam);
