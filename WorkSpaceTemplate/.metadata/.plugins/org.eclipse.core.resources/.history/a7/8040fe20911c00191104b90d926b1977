...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<c:forEach items="${cartList }" var="cart" varStatus="status">
			...
			<input type="hidden" name="itemList[${status.index}].itemId" value="${cart.id}"/>
			<input type="hidden" name="itemList[${status.index}].num" value="${cart.num }"/>
			<input type="hidden" name="itemList[${status.index}].price" value="${cart.price}"/>
			<input type="hidden" name="itemList[${status.index}].totalFee" value="${cart.price * cart.num}"/>
			<input type="hidden" name="itemList[${status.index}].title" value="${cart.title}"/>
			<input type="hidden" name="itemList[${status.index}].picPath" value="${cart.image}"/>
		</c:forEach>
