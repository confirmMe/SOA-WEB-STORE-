 ...
 * Generated at: 2019-01-15 02:20:57 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t<a href=\"/\" class=\"flk13\">登录</a>\r\n");
      out.write("        </span>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"fl item-ifo\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" id=\"email\" maxlength=\"20\" name=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"text\" tabindex=\"4\"\r\n");
      out.write("\t\t\t\t\t\t\t\tautocomplete=\"off\" /> <i class=\"i-phone\"></i> <label\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"phone_succeed\" class=\"blank\"></label> <label\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"phone_error\"></label>\r\n");
      ...
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t            \turl : REGISTER.param.surl + \"/user/check/?param=\"+$(\"#regName\").val()+\"&&type=1&&r=\" + Math.random(),\r\n");
      out.write("\t            \tsuccess : function(data) {\r\n");
      out.write("\t            \t\tif (data.data) {\r\n");
      out.write("\t            \t\t\t//检查手机号是否存在\r\n");
      out.write("\t            \t\t\t$.ajax({\r\n");
      out.write("\t            \t\t\t\turl : REGISTER.param.surl +  \"/user/check/?param=\"+$(\"#phone\").val()+\"&&type=2&&r=\" + Math.random(),\r\n");
      out.write("\t\t\t\t            \tsuccess : function(data) {\r\n");
      out.write("\t\t\t\t            \t\tif (data.data) {\r\n");
      out.write("\t\t\t\t\t            \t\t\r\n");
      out.write("\t\t\t\t            \t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t            \t\t\t\turl : REGISTER.param.surl + \"/user/check/?param=\"+$(\"#email\").val()+\"&&type=3&&r=\" + Math.random(),\r\n");
      out.write("\t\t\t\t\t\t\t            \tsuccess : function(data) {\r\n");
      out.write("\t\t\t\t\t\t\t            \t\tif (data.data) {\r\n");
